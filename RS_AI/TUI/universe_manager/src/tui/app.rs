...
impl App {
    ...
    pub fn handle_enter(&mut self) -> EnterResult {
        match self.current_screen {
            Screen::MainMenu => match self.menu_index {
                0 => {
                ...
                4 => EnterResult::RunCleanLeftovers,
                5 => {
            ...
            Screen::UninstallList => EnterResult::RunUninstalls,
            Screen::AutostartManager => {
                self.delete_selected_autostart();
                EnterResult::None
            }
            Screen::UpdateManager => EnterResult::None,
            Screen::PackageManagerInstaller => EnterResult::None,
            Screen::AppInstaller => EnterResult::None,
        }
    }
    ...
    pub fn execute_operations(&mut self) {
        ...
        let selected_apps: Vec<AppEntry> = self
            .apps_with_status
            .iter()
